# Baby Product Shop - WEB API .NET 8

## Overview
Baby Product Shop is a RESTful Web API built with .NET 8, designed following best practices of REST architecture. The project is structured in layers to ensure scalability, maintainability, and clean code principles.
...
---
## Contact Information
- **Name**: Dvora Greiniman
- **Phone**: 0556743326
- **Email**: d07080120@gmail.com
